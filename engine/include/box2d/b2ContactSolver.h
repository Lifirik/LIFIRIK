...
struct b2ContactConstraint
{
	...
	float64 friction;
	float64 restitution;
	// LIFIRIK addition (belts): target relative tangent velocity of the pair,
	// shape2's surface speed minus shape1's. 0 everywhere except on a belt,
	// and at 0 the tangent solve below is byte-for-byte the original.
